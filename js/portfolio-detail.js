...
var s=m[1];
var D={
'aquablu':{n:'Aquablu',f:'Marnix Stokvis & Marc van Zuylen',y:'2025',c:'Nederland',sc:'Duurzaamheid / Water',tl:'Duurzame wateroplossingen',url:'aquablu.com',
...
'brainial':{n:'Brainial',f:'Fedor Klinkenberg & Taco Hiddink',y:'2025',c:'Nederland',sc:'Software / Aanbestedingen',tl:'AI-software voor aanbestedingen',url:'brainial.com',
...
'leasy':{n:'Leasy',f:'Gregorio Gilardini & Alejandro Garay',y:'2022',c:'Spanje',sc:'Fintech / Auto Leasing',tl:'Transparante autolease',url:'leasy.com',
...
'anthropic':{n:'Anthropic',f:'Dario Amodei',y:'2021',c:'Verenigde Staten',sc:'Artificial Intelligence',tl:'AI-veiligheidsbedrijf achter Claude',url:'anthropic.com',
...
'mamas-maaltijden':{n:"Mama's Maaltijden",f:'Serdar Tolenaar, Rick Hageman & Henk Brussaard',y:'2019',c:'Nederland',sc:'Food / Maaltijden',tl:'Koelverse maaltijden',url:'mamasmaaltijden.nl',
...
'apollo-lane':{n:'Apollo Lane',f:'Pieter Schoen & Diederik Ingen Housz',y:'2023',c:'Nederland',sc:'Investeringen',tl:'Investeringsvehikel',url:'',
...
'carv':{n:'Carv',f:'Matthijs Metzemaekers & Barend Raaff',y:'2021',c:'Nederland',sc:'HR Tech / AI Recruitment',tl:'AI recruitment platform',url:'carv.com',
...
'loop':{n:'Loop',f:'Bob Hendrikx & Lonneke Westhoff',y:'2019',c:'Nederland',sc:'Duurzaamheid / Biobased',tl:'Biologisch afbreekbare doodskisten',url:'loop-biotech.com',
...
'revolut':{n:'Revolut',f:'Nik Storonsky',y:'2023',c:'Verenigd Koninkrijk',sc:'Fintech / Neo-bank',tl:'Europees fintech-platform',url:'revolut.com',
...
'ixxi':{n:'IXXI',f:'Erik-Jan Schreurs, Luc Hendriks & Thomas Beguin',y:'2018',c:'Nederland',sc:'Design / Woonaccessoires',tl:'Modulaire wanddecoratie',url:'ixxi.com',
...
'grantific':{n:'Grantific',f:'Theodoor Rutgers',y:'2023',c:'Nederland',sc:'Software / Subsidies',tl:'Subsidieplatform voor ondernemers',url:'grantific.com',
...
'bright-bird':{n:'Bright Bird',f:'Camiel Kuik & Claris Schoen',y:'2022',c:'Nederland',sc:'EdTech / Kinderen',tl:'Educatief platform voor kinderen',url:'brightbird.app',
...
'airwallex':{n:'Airwallex',f:'Jack Zhang',y:'2023',c:'Australi\u00eb',sc:'Fintech / Betalingen',tl:'Grensoverschrijdende betalingen',url:'airwallex.com',
...
'liquido-doro':{n:"Liquido d'Oro",f:'Ridder Drost',y:'2018',c:'Nederland',sc:'Food & Beverage / Olijfolie',tl:'Premium Italiaanse olijfolie',url:'liquidodoro.com',
...
'zkr':{n:'Zkr.',f:'Khalid Maatoug & Tarik Joemmanbaks',y:'2022',c:'Nederland',sc:'Fintech / Krediet',tl:'Kredietoplossingen voor consumenten',url:'zkr.nl',
...
'replit':{n:'Replit',f:'Amjad Masad & Haya Odeh',y:'2023',c:'Verenigde Staten',sc:'Developer Tools / AI',tl:'Online coding platform met AI',url:'replit.com',
...
'creditchecken':{n:'Creditchecken',f:'Tarik Joemmanbaks',y:'2020',c:'Nederland',sc:'Fintech / Kredietinformatie',tl:'Inzicht in je kredietwaardigheid',url:'creditchecken.nl',
...
'equalture':{n:'Equalture',f:'Fleur & Charlotte Melkert',y:'2019',c:'Nederland',sc:'HR Tech / Inclusie',tl:'Eerlijker werven via gamificatie',url:'equalture.com',
...
'focus':{n:'Focus',f:'Thijs van de Poll & Jard van Ingen',y:'2021',c:'Nederland',sc:'AI / Patent Intelligence',tl:'AI-gedreven patent intelligence',url:'focus.ai',
...
'colect':{n:'Colect',f:'Nick Andriesse',y:'2018',c:'Nederland',sc:'Fashion Tech / B2B',tl:'B2B fashion platform',url:'colect.io',
...
'swishfund':{n:'Swishfund',f:'Pieter Schoen & Bart-Jan van Genderen',y:'2019',c:'Nederland',sc:'Fintech / MKB Financiering',tl:'Snelle financiering voor het MKB',url:'swishfund.nl',
...
'dealroom':{n:'Dealroom',f:'Yoram Wijngaarde',y:'2019',c:'Nederland',sc:'Data / Startup Intelligence',tl:'Europese startup data',url:'dealroom.co',
...
'creative-clicks':{n:'Creative Clicks',f:'Ramon van den Bulk & Raymond Kokken',y:'2017',c:'Nederland',sc:'Digital Marketing / Ad Tech',tl:'Performance advertising',url:'creativeclicks.com',
...
'mega':{n:'Mega',f:'Micheal Corhay & Thomas Coune',y:'2015',c:'Nederland',sc:'Energie / Duurzaam',tl:'Groene energieleverancier',url:'',x:true,
...
'isolatiespecialist':{n:'Isolatiespecialist',f:'Marc & Margreet Anker',y:'2017',c:'Nederland',sc:'Bouw / Isolatie',tl:'Isolatiediensten voor woningen',url:'',x:true,
...
'charlie-temple':{n:'Charlie Temple',f:'Leon Planken',y:'2016',c:'Nederland',sc:'Retail / Brillen',tl:'Online brillenretailer',url:'',x:true,
...
if(t==='This is some text inside of a div block.'||t==='Company tagline goes here')e.style.display='none'
}
});
...
e.textContent=d.tl;e.style.display='';
e.style.cssText='font-size:18px;color:#555;margin-bottom:16px'
}
})
}

// Add info bar after h1
var st=d.x?'Exit':'Huidig';
var bar=document.createElement('div');
bar.style.cssText='display:flex;flex-wrap:wrap;align-items:center;gap:16px;padding:20px 0;border-bottom:1px solid #e5e7eb;margin-bottom:24px;color:#555;font-size:15px';
bar.innerHTML='<span style="background:'+(d.x?'#dc3545':'#28a745')+';color:#fff;padding:4px 12px;border-radius:20px;font-size:12px;font-weight:600;text-transform:uppercase;letter-spacing:1px">'+st+'</span>'
+'<span><strong>Oprichter'+(d.f.indexOf('&')>-1?'s':'')+':</strong> '+d.f+'</span>'
+'<span><strong>Sector:</strong> '+d.sc+'</span>'
+'<span><strong>Partner sinds:</strong> '+d.y+'</span>'
+'<span><strong>Land:</strong> '+d.c+'</span>';
var h1=document.querySelector('h1');
if(h1&&h1.parentNode)h1.parentNode.insertBefore(bar,h1.nextSibling);

// Add description
var desc=document.createElement('div');
desc.style.cssText='max-width:720px;line-height:1.8;font-size:16px;color:#333;margin:24px 0 32px';
desc.innerHTML='<p>'+d.d+'</p>';
if(bar.parentNode)bar.parentNode.insertBefore(desc,bar.nextSibling);

// Set website link
if(d.url){
document.querySelectorAll('a').forEach(function(a){
if(a.textContent.indexOf('Bezoek website')>-1){
a.href='https://'+d.url;a.target='_blank';
a.style.cssText='display:inline-block;background:#1a5276;color:#fff;padding:12px 24px;border-radius:6px;text-decoration:none;font-weight:600;font-size:15px;margin-top:8px'
}
})
}

// Add website button if not already present
if(d.url){
var hasBtn=false;
document.querySelectorAll('a').forEach(function(a){if(a.textContent.indexOf('Bezoek website')>-1)hasBtn=true});
if(!hasBtn&&desc.parentNode){
var btn=document.createElement('a');
btn.href='https://'+d.url;btn.target='_blank';
btn.textContent='Bezoek website \u2192';
btn.style.cssText='display:inline-block;background:#1a5276;color:#fff;padding:12px 24px;border-radius:6px;text-decoration:none;font-weight:600;font-size:15px;margin-top:8px';
